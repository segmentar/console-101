    ...
    public partial class Contribute
    {
        public static IList<Contribute> ContributeDefaultSet(String[] array_STRING)
        {
            ...
            do
            {
                ...
                ContributeEnumPredicate contributeEnumSafe;

                contributeEnumSafe = new ContributeEnumPredicate();

                contributeEnumSafe.TabulationType = tabulationType;

                contributeEnumSafe.StringValue = reflect;

                Contribute contribute;

                contribute = MakeContributeDefaultSurface(contributeEnumSafe, split);
